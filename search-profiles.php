...
<html lang="en">
  <head>
    <title>Project Space - Search Skills</title>
    <meta charset="utf-8">
           		...
           		<div class="col-xs-12 col-md-8 div-center">
					...
					<?php 
						if ($count == 0){
							...
							echo "<h4 class=\"lightgray\">Sorry, no skills found matching that criteria</h4>";
							echo "<br>";
							echo "<a href=\"profiles.php\" style=\"color: gray;\"><span class=\"glyphicon glyphicon-th-list\"> </span> Go back to profiles</a>";
							echo "</div>";
							echo "<br><br>";						
						}
						else{
