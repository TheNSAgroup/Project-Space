        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-xs-11 col-sm-10 div-center text-center">
								...
								<h4><span class="input-icon fui-check"> </span>
                                    <?php
                                        if ($action == "update"){
                                            ...
                                            mysqli_query($link,"UPDATE $tbl_name 
                                                SET FirstName='$fname',
                                                    LastName='$lname',
                                                    Email = '$toemail',
                                                    Password = '$pword'    
                                        ...
                                        if ($action == "delete"){
                                            $status = mysqli_query($link,"DELETE FROM $tbl_name WHERE Email='$email'");
                                            session_unset();
                                            session_destroy();
							...
							<a href="<?php if ($action == "update"){ echo "account.html"; }else{ echo "projects.php"; } ?>" style="color: gray;"><span class="glyphicon glyphicon-th-list"> </span><?php if ($action == "update"){ echo " Go back to account"; }else{ echo " Go back to projects"; } ?></a>
