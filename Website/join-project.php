...
if(isset($_POST['emailto'])) {
    ...
    $email_subject = "ProjectSpace: Someone wants to join your project";
    ...
    $comments = "Someone is interested in your project you posted on Project Space. If you reply to this message it will go directly to that person."; // required
    ...
    <div id="wrap">
        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-xs-10 col-lg-8 div-center text-center">
					 <div class="alert alert-success text-center">
						<h4><span class="input-icon fui-check"> </span> Great! The project moderator will contact you shortly.</h4>	
					</div>
