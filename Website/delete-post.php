<?php
	...
	$status = mysqli_query($link,"DELETE FROM $tbl_name WHERE id='$postID'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12" id="banner" style="background-image: url(images/banner1.jpg);">
                        <h1 class="uppercase" id="banner-text">Delete post</h1> <!-- CHANGE THIS -->
                    </div>
                </div>
            ...
            <div class="row">
				...
				<div class="col-xs-11 col-sm-10 div-center text-center">
							<div class="alert alert-success text-center">
								<h4><span class="input-icon fui-check"> </span> Post deleted successfully.</h4>	
							</div>
						
							<br>
					
							<a href="my-posts.php" style="color: gray;"><span class="glyphicon glyphicon-th-list"> </span> Go back to my posts</a>
