    ...
    <div id="wrap">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12" id="banner" style="background-image: url(images/banner1.jpg);">
                        <h1 class="uppercase" id="banner-text">Password recovery</h1> <!-- CHANGE THIS -->
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6 div-center">
						<br><br>
						
						<form action="forgot.php" method="post" class="well well-lg"  role="form">
							...
							<br>
							<input type="submit" name="submit" class="btn btn-info text-center" value="Recover password">
							<br>
							...
							<?php
								...
								if(mysql_num_rows($result))
								{
								  ...
								  -------------------------------
										...
										$subject = "Project Space login information";
										$headers1 = "From: $from \n";
										...
										echo "<br>";
								  		echo "<span class='label label-success'>Success</span> Your login information has been sent. Please check your inbox.";

								 }
								 else
								 {
									echo "<br>";
									echo "<span class='label label-danger'>Error</span> That email does not exist in our database. Please try again.";
								 }
